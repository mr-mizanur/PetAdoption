...
//  const [mounted, setMounted] = useState(false); // হাইড্রেশন এরর এড়ানোর জন্য
              ...
              <AnimatePresence>
                {isDashboardOpen && (
                  <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 10 }} className="absolute right-0 mt-2 w-56 bg-slate-900 border border-white/10 p-2 rounded-2xl z-50 shadow-xl">
                    <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2.5 hover:bg-white/5 rounded-xl text-xs font-bold text-slate-300 transition-colors"> <FaUserShield className="text-emerald-400" /> Dashboard </Link>
                    <Link href="/add-pet" className="flex items-center gap-3 px-3 py-2.5 hover:bg-white/5 rounded-xl text-xs font-bold text-slate-300 transition-colors"> <FaPlusCircle className="text-emerald-400" /> Add Pet </Link>
                    <Link href="/my-pets" className="flex items-center gap-3 px-3 py-2.5 hover:bg-white/5 rounded-xl text-xs font-bold text-slate-300 transition-colors"> <FaList className="text-emerald-400" /> My Pets </Link>
                    <Link href="/wishlist" className="flex items-center gap-3 px-3 py-2.5 hover:bg-white/5 rounded-xl text-xs font-bold text-slate-300 transition-colors"> <FaHeart className="text-emerald-400" /> Wishlist </Link>
