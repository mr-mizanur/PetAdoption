  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-28 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
        ...
        <div className="lg:col-span-4 lg:sticky lg:top-24 h-fit">
          {pet.status === "adopted" ? (
            <div className="bg-slate-900/40 backdrop-blur-xl border border-emerald-500/20 p-8 rounded-3xl text-center space-y-4 shadow-2xl">
              <div className="w-16 h-16 bg-emerald-500/10 rounded-full flex items-center justify-center mx-auto text-emerald-400">
                <FaCheckCircle size={32} />
              </div>
              <h2 className="text-xl font-black text-white">Already Adopted</h2>
              <p className="text-slate-400 text-sm">
                This companion, <span className="text-emerald-400 font-bold">{pet.name}</span>, has already been successfully transitioned to a new sanctuary.
              </p>
            </div>
          ) : (
            <AdoptionFrom pet={pet} />
