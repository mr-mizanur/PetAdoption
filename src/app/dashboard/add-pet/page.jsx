      ...
      <AnimatePresence>
        {notification.show && (
          <motion.div 
            ...
            className={`fixed top-6 right-6 z-50 px-6 py-4 rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.5)] border text-xs font-black uppercase tracking-widest flex items-center gap-3 ${
              notification.type === "success" 
                ? "bg-slate-950 text-emerald-400 border-emerald-500/30 shadow-emerald-500/10" 
                : "bg-slate-950 text-rose-500 border-rose-500/30 shadow-rose-500/10"
            }`}
          >
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white">
          ...
          <div className="md:col-span-2 space-y-2">
            ...
            <div className="relative flex items-center">
              ...
              <input type="email" name="ownerEmail" value="shelter1@gmail.com" readOnly className="w-full bg-slate-950/30 border border-white/5 rounded-xl pl-10 pr-4 py-3.5 text-sm text-slate-500 font-bold tracking-wide cursor-not-allowed outline-none select-none" />
            </div>
          </div>
